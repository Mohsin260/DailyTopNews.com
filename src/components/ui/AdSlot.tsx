...
interface Props {
    ...
    adOverrideId?: string;
    articleSlug?: string;
    /** Spacer class rendered only when this ad is visible (e.g. "space-30") */
    beforeSpaceClass?: string;
    /** Spacer class rendered only when this ad is visible */
    afterSpaceClass?: string;
    /** Wrapper class applied around the whole slot only when visible (e.g. "banner_area mt50 mb60 xs-mt60") */
...
function AdSlotInner({
    ...
    useEffect(() => {
        ...
        if (isVastAd || isDirectVideo || (ad?.code && ad.code.includes("window.NewsPrkAds.push"))) {
            ...
            if (isHtmlBanner) {
                ...
                wrapper.innerHTML = `
<div id="NewsPrk-banner-ad-${safePosition}" style="width:100%; max-width:${maxW}px; height:${maxH}px; margin:0 auto; position:relative; overflow:hidden; display:flex; align-items:center; justify-content:center;">
  ...
  <div id="nv-companion-ad-${safePosition}" style="margin-top:10px; text-align:center;"></div>
                ...
                wrapper.innerHTML = `
<div id="NewsPrk-video-ad-${safePosition}" style="width:${maxW}px; height:${maxH}px; margin:0 auto; position:relative; overflow:hidden; display:flex; align-items:center; justify-content:center; background:#000;">
...
<div id="NewsPrk-video-ad-${safePosition}" style="width:${maxW}px; height:${maxH}px; margin:0 auto; position:relative; overflow:hidden; display:flex; align-items:center; justify-content:center; background:#000;">
  <video id="nv-video-player-${safePosition}" class="video-js vjs-big-play-centered" style="width:${maxW}px; height:${maxH}px; border-radius:8px; background:#000; display:block;" playsinline webkit-playsinline="true" muted></video>
            ...
            styleOverride.textContent = `
                ...
                #NewsPrk-video-ad-${safePosition},
                #NewsPrk-banner-ad-${safePosition} {
                ...
                #NewsPrk-video-ad-${safePosition} .video-js,
                #NewsPrk-banner-ad-${safePosition} .video-js {
                    width: ${maxW}px !important;
                    height: ${maxH}px !important;
                    max-width: ${maxW}px !important;
                    max-height: ${maxH}px !important;
                ...
                #NewsPrk-video-ad-${safePosition} .video-js .vjs-tech,
                #NewsPrk-banner-ad-${safePosition} .video-js .vjs-tech {
                ...
                #NewsPrk-video-ad-${safePosition} .vjs-control-bar,
                #NewsPrk-banner-ad-${safePosition} .vjs-control-bar {
                    display: flex !important;
                    opacity: 1 !important;
                ...
                #NewsPrk-video-ad-${safePosition} .vjs-control-bar .vjs-button,
                #NewsPrk-banner-ad-${safePosition} .vjs-control-bar .vjs-button {
                 ...
                 */
                #NewsPrk-video-ad-${safePosition} video,
                #NewsPrk-banner-ad-${safePosition} video {
                 ...
                 */
                #NewsPrk-video-ad-${safePosition} .video-js [class*="ima-ad-container"],
                #NewsPrk-banner-ad-${safePosition} .video-js [class*="ima-ad-container"],
                #NewsPrk-video-ad-${safePosition} .video-js .ima-ad-container,
                #NewsPrk-banner-ad-${safePosition} .video-js .ima-ad-container {
                    position: absolute !important;
                    top: 0 !important;
                    left: 0 !important;
                    width: 100% !important;
                ...
                #NewsPrk-video-ad-${safePosition} .ima-ad-container video,
                #NewsPrk-banner-ad-${safePosition} .ima-ad-container video,
                #NewsPrk-video-ad-${safePosition} [class*="ima-ad-container"] video,
                #NewsPrk-banner-ad-${safePosition} [class*="ima-ad-container"] video {
                    position: absolute !important;
                    top: 0 !important;
                    left: 0 !important;
                    width: 100% !important;
                ...
                #NewsPrk-video-ad-${safePosition} [class*="ima"] [class*="controls"],
                #NewsPrk-banner-ad-${safePosition} [class*="ima"] [class*="controls"],
                #NewsPrk-video-ad-${safePosition} [class*="ima"] [class*="ui"],
                #NewsPrk-banner-ad-${safePosition} [class*="ima"] [class*="ui"] {
                    pointer-events: auto !important;
                ...
                #NewsPrk-video-ad-${safePosition} [class*="ima"] [class*="skip"],
                #NewsPrk-banner-ad-${safePosition} [class*="ima"] [class*="skip"],
                #NewsPrk-video-ad-${safePosition} .ima-skip-button,
                #NewsPrk-banner-ad-${safePosition} .ima-skip-button {
                    display: block !important;
                    visibility: visible !important;
                    opacity: 1 !important;
                    z-index: 10002 !important;
                ...
                #NewsPrk-video-ad-${safePosition} [class*="ima"] [class*="countdown"],
                #NewsPrk-banner-ad-${safePosition} [class*="ima"] [class*="countdown"],
                #NewsPrk-video-ad-${safePosition} [class*="ima"] [class*="ad-label"],
                #NewsPrk-banner-ad-${safePosition} [class*="ima"] [class*="ad-label"] {
                    display: block !important;
                    visibility: visible !important;
                    opacity: 1 !important;
                    z-index: 10002 !important;
                ...
                #NewsPrk-video-ad-${safePosition} [class*="ima"] [class*="progress"],
                #NewsPrk-banner-ad-${safePosition} [class*="ima"] [class*="progress"],
                #NewsPrk-video-ad-${safePosition} .ima-progress-div,
                #NewsPrk-banner-ad-${safePosition} .ima-progress-div {
                    display: block !important;
                    visibility: visible !important;
                    opacity: 1 !important;
                    z-index: 10002 !important;
                ...
                #NewsPrk-video-ad-${safePosition} [class*="ima"] [class*="progress"] [class*="fill"],
                #NewsPrk-banner-ad-${safePosition} [class*="ima"] [class*="progress"] [class*="fill"] {
                ...
                #NewsPrk-video-ad-${safePosition} .vjs-fullscreen-control,
                #NewsPrk-banner-ad-${safePosition} .vjs-fullscreen-control {
                    ...
                    try {
                        ...
                        player.ready(() => {
                            ...
                            player.on('ads-ad-started', () => {
                                ...
                                const videoContainer = document.getElementById(isBanner ? `NewsPrk-banner-ad-${safePosition}` : `NewsPrk-video-ad-${safePosition}`);
                                if (videoContainer) {
...
${ad.code}
    ...
    if (isLoading || adsGloballyDisabled || !ad || !ad.enabled || isClosed) {
        return null;
    }

    // Don't render if ad has no actual content configured
    const native = ad.nativeContent as { title?: string; image?: string } | undefined;
    const nativeHasContent = !!(
        (native?.title || "").trim() ||
        (native?.image || "").trim()
    );
    const hasContent = !!(
    ...
    // height:auto: size comes from .ad-media-wrapper pixel box (website has no Tailwind height utilities)
    ...
    return (
        <>
            {beforeSpaceClass && <div className={beforeSpaceClass} />}
            {wrapperClassName ? (
            ...
            {afterSpaceClass && <div className={afterSpaceClass} />}
        </>
    );
    ...
    return (
            <div
                ...
                style={{
                    ...
                    ...appearanceStyle,
                    overflow: "visible",
                    ...(fullWidth ? { width: "100%" } : { marginLeft: "auto", marginRight: "auto" }),
                }}
            >
                ...
                {containerSizing && isMounted && (
                    <style dangerouslySetInnerHTML={{
                        ...
                        [data-ad-position="${position}"] .ad-media-wrapper {
                            ...
                            max-width: 100% !important;
                            overflow: hidden !important;
                            background-color: ${appearance.backgroundColor && appearance.backgroundColor !== "transparent" ? appearance.backgroundColor : "transparent"};
                        }

                        /* Content host must fill the media wrapper (not the AD badge) */
                        [data-ad-position="${position}"] .ad-slot-content,
                        [data-ad-position="${position}"] .ad-slot-content > a,
                ...
                <div className="ad-frame">
                    <div
                        className="ad-media-wrapper"
                        onClick={handleAdClick}
                    >
                        {/* AD Badge — absolute so it never takes flow space / empties the slot */}
                        {displayLabel && (
