  ...
  useEffect(() => {
    if (data?.item) {
      ...
      setSocialLinks(data.item.socialLinks || [
        { name: "Facebook", network: "facebook", url: "https://Dailytopnews.com", count: "125K" },
        { name: "Twitter", network: "twitter", url: "https://Dailytopnews.com", count: "89K" },
        { name: "YouTube", network: "youtube", url: "https://Dailytopnews.com", count: "1.2M" },
        { name: "Instagram", network: "instagram", url: "https://Dailytopnews.com", count: "550K" },
      ]);
    }
  }, [data]);
