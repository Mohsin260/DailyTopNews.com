...
<body>
  <div class="container">
    <div class="header">
      <a href="${BASE_URL}" class="logo">Dailytopnews</a>
    </div>
    <div class="content">
      ${content}
    </div>
    <div class="footer">
      <p>Dailytopnews - Your daily source for viral stories.</p>
      ${footerAddon}
    </div>
  </div>
</body>
...
export async function sendInviteEmail(email: string, token: string) {
  ...
  const html = baseHtml(`
    ...
    <p>You have been invited to join the Dailytopnews team.</p>
  ...
  return sendEmail({
    to: email,
    subject: "You've been invited to join Dailytopnews",
    html
  });
}
...
<body>
  <div class="container">
    ...
    <div class="footer">
      <p>You received this email because you are subscribed to Dailytopnews.</p>
