...
export async function getSocialSettingsAction() {
  try {
    ...
    const defaultSocials = [
      { name: "Facebook", count: "125K", label: "Fans", network: "facebook", url: "https://Dailytopnews.com" },
      { name: "Twitter", count: "89K", label: "Followers", network: "twitter", url: "https://Dailytopnews.com" },
      { name: "YouTube", count: "1.2M", label: "Subscribers", network: "youtube", url: "https://Dailytopnews.com" },
      { name: "Instagram", count: "550K", label: "Followers", network: "instagram", url: "https://Dailytopnews.com" },
    ];
