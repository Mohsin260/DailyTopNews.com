...
export async function exampleCloudinaryUploadFlow() {
  ...
  const cloudinaryResponse = {
    public_id: 'NewsPrk/images/sample-photo',
    secure_url: 'https://res.cloudinary.com/demo/image/upload/v1234567890/NewsPrk/images/sample-photo.jpg',
    format: 'jpg',
    resource_type: 'image',
    bytes: 2048000,
    width: 1920,
...
export async function exampleAdUploadFlow() {
  ...
  const cloudinaryResponse = {
    public_id: 'NewsPrk/ads/promo-ad',
    secure_url: 'https://res.cloudinary.com/demo/video/upload/v1234567890/NewsPrk/ads/promo-ad.mp4',
    format: 'mp4',
    resource_type: 'video',
    bytes: 5242880,
    width: 1920,
